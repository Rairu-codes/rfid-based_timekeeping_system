    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (action != null && action.equals("delete") && userID != null) {
                ...
                response.sendRedirect(request.getContextPath() + "AdminViewEmployees");
                return;
            }
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("AdminViewEmployees.jsp");
       ...
       String action = request.getParameter("action");
        ...
        try {
            ...
            if (emailExists(connection, email, userIdInt)) {
                ...
                request.getRequestDispatcher("AdminViewEmployees.jsp").forward(request, response);
                return;
            }
