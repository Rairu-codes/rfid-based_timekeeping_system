...
<head>
    ...
    <title>Error Logs | Torres Technology Corporation</title>
    <style>
        body {
...
<body>
 <header>
    ...
    <div class="nav-links">
        ...
        <a href="ErrorLogsServlet" class="active"">Error Logs</a>
