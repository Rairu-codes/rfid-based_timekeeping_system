...
<body>
 <header>
    ...
    <div class="nav-links">
        ...
        <a href="LogsServlet" class="active">Employee Time Logs</a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><%= log.get("rfid_tag") %></td>
            <td><%= log.get("name") %></td>
            <td><%= log.get("position") %></td>
            <td><%= log.get("department") %></td>
            <td><%= log.get("shift_type") %></td>
            <td><%= log.get("time_in") %></td>
            <td><%= log.get("time_out") %></td>
            <td><%= log.get("time_in_status") %></td>
            <td><%= log.get("time_out_status") %></td>
            <td><%= log.get("holiday") %></td>
            <td><%= log.get("sunday") %></td>
        </tr>
        <%  
                }
            } else {
        %>
        <tr><td colspan="13">No logs found</td></tr>
        <%  
            }
        %>
    </tbody>
