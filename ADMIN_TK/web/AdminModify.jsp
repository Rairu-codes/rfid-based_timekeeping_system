...
<body>
    ...
    <div class="nav-links">
        <a href="AdminAddEditDeletedashboard.jsp">Dashboard</a>
        <a href="AdminModify" class="active">Manage Users</a>
    ...
    <div class="container">
        <form action="AdminModify" method="POST" onsubmit="return confirmAddUser();">
            <h3>Add User</h3>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="AdminModify?action=delete&id=<%= user.get("user_id") %>" onclick="return confirm('Are you sure you want to delete this user?');" class="action-btn delete-btn">Delete</a>
                        </td>
                    </tr>
                    <%  
                            }
    ...
    <script>
        ...
        function saveUser(userId) {
            ...
            xhr.open("POST", "AdminModify", true);
