...
<body>
    ...
    <c:if test="${not empty message}">
        <div class="message-box success">
          ...
          <div class="container">
        <form action="AdminEditDelete" method="GET">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="AdminEditDelete?action=delete&id=<%= user.get("user_id") %>" onclick="return confirm('Are you sure you want to delete this user?');" class="action-btn delete-btn">Delete</a>
                        </td>
                    </tr>
                    <%  
                            }
    ...
    <script>
        ...
        function saveUser(userId) {
            ...
            xhr.open("POST", "AdminEditDelete", true);
