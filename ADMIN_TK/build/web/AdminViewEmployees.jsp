...
<body>
 <header>
    ...
    <div class="nav-links">
        ...
        <a href="AdminViewEmployees" class="active">Employee List</a>
    ...
    <div class="container">
    <form action="AdminViewEmployees" method="GET">
